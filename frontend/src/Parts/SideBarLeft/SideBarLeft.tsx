...
function SideBarLeft() {
    ...
    return (
        <div className='fixed flex flex-col justify-between overflow-y-auto pt-2 px-3 pb-3 w-[244px] left-0 top-0 bottom-0 bg-white dark:bg-black border-r border-r-gray-400'>
            <div className='flex flex-col'>
                {/* insta image */}
                <div className='mb-[19px] pt-[25px] px-3 pb-4 flex justify-start'>
                ...
                <ul className='flex flex-col gap-3'>
                    <li className='p-3 rounded-md hover:bg-[#00376b1a] dark:hover:bg-[#e0f1ff21] transition-all duration-300 group'>
                        <Link className='text-base/5 flex items-center gap-3 font-bold text-black dark:text-white' to='/'>
                    ...
                    <li className='p-3 rounded-md hover:bg-[#00376b1a] dark:hover:bg-[#e0f1ff21] transition-all duration-300 group'>
                        <Link className='text-base/5 flex items-center gap-3 font-bold text-black dark:text-white' to='/search'>
                            <div className='w-6 h-6 group-hover:scale-110 transition-all duration-300'>
                                {searchIcon}
                            </div>
                            Search
                    ...
                    <li className='p-3 rounded-md hover:bg-[#00376b1a] dark:hover:bg-[#e0f1ff21] transition-all duration-300 group'>
                        <Link className='text-base/5 flex items-center gap-3 font-bold text-black dark:text-white' to='/direct'>
                            <div className='w-6 h-6 group-hover:scale-110 transition-all duration-300'>
                                {messageOutline}
                            </div>
                            Messages
                    ...
                    <li className='p-3 rounded-md hover:bg-[#00376b1a] dark:hover:bg-[#e0f1ff21] transition-all duration-300 group'>
                        <Link className='text-base/5 flex items-center gap-3 font-bold text-black dark:text-white' to={`/profile/${authContext?.user?._id}`}>
                            <div className='w-6 h-6 group-hover:scale-110 transition-all duration-300'>
                    ...
                    <li onClick={() => { setNewPost(true) }} className='p-3 rounded-md hover:bg-[#00376b1a] dark:hover:bg-[#e0f1ff21] transition-all duration-300 group'>
                        <button className='text-base/5 flex items-center gap-3 font-bold text-black dark:text-white'>
                            <div className='w-6 h-6 group-hover:scale-110 transition-all duration-300'>
                                {postUploadOutline}
                            </div>
                            Create
                    ...
                    <FormControlLabel
                        ...
                        sx={{
                            '& .MuiFormControlLabel-label': {
                                color: '#9CA3AF', // تغییر رنگ
                                fontSize: '16px', // تغییر اندازه فونت
                                fontWeight: '700', // تغییر فونت
                            },
                        }}
                    />
