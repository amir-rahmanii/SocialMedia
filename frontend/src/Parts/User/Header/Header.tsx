...
export default function Header() {
    ...
    return (
        <>
            <nav className="fixed md:hidden top-0 w-full border-b dark:border-gray-300/20 border-gray-300 bg-white dark:bg-black z-30">
                {/* <!-- navbar container --> */}
                <div className="flex flex-row justify-between items-center py-3 px-3.5 sm:w-full sm:py-2 sm:px-4 md:w-full md:py-2 md:px-6 xl:w-4/6 xl:py-3 xl:px-8 mx-auto">
                    ...
                    <div className="flex items-center">
                        ...
                        <button className='w-6 h-6 text-black dark:text-white' onClick={() => setShowOption(true)}>
                            {metaballsMenu}
                        </button>
                    </div>
            ...
            {/* option */}
            <ShowDialogModal
                isOpenShowLDialogModal={showOption}
                setisOpenShowLDialogModal={setShowOption}
                title="Option"
                height="h-auto"
            >
                <ul className="border flex flex-col rounded dark:border-gray-300/20 border-gray-300">
                    <li onClick={() => { 
                        setShowOption(false)
                        setNewPost(true) 
                        }} className='p-3 flex items-center justify-center  border-b dark:border-gray-300/20 border-gray-300  hover:bg-[#00376b1a] dark:hover:bg-[#e0f1ff21] transition-all duration-300 group'>
                    ...
                    <li onClick={() => {
                        ...
                        }} className='p-3 rounded-md hover:bg-[#00376b1a] dark:hover:bg-[#e0f1ff21] transition-all duration-300 group border-b dark:border-gray-300/20 border-gray-300'>
                        <div className='text-base/5 flex items-center justify-center  gap-3 font-bold text-black dark:text-white'>
                            <span>Search</span>
                            <div className='w-6 h-6 group-hover:scale-110 transition-all duration-300'>
                                {searchIcon}
                            </div>
