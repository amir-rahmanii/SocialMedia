                    ...
                    <ul className='flex flex-col gap-3'>
                        <li>
                            <NavLink to='panel' className={({ isActive }) =>
                                ...
                                <span className='text-base hidden lg:block'>Home</span>
                            </NavLink>
                        </li>
                        <li>
                            <NavLink to='profile' className={({ isActive }) =>
                                ...
                                <span className='text-base hidden lg:block'>Profile</span>
                            </NavLink>
                        </li>
                        <li>
                            <NavLink to='users' className={({ isActive }) =>
                                ...
                                <span className='text-base hidden lg:block'>Users</span>
                            </NavLink>
                        </li>
                        <li>
                            <NavLink to='tickets' className={({ isActive }) =>
                                ...
                                <span className='text-base hidden lg:block'>Tickets</span>
                            </NavLink>
                        </li>
                        <li>
                            <NavLink to='posts' className={({ isActive }) =>
                                ...
                                <span className='text-base hidden lg:block'>Posts</span>
                            </NavLink>
                        </li>
                        <li>
                            <NavLink to='messages' className={({ isActive }) =>
                                ...
                                <span className='text-base hidden lg:block'>Messages</span>
                            </NavLink>
                        </li>
                        <li>
            ...
            {showSidebarLeftMobile && (
                    <div className={`transition-all md:hidden z-50 bg-admin-black font-medium duration-300 fixed top-0 bottom-0 w-[280px] p-5 overflow-y-auto ${showSidebarLeftMobile ? 'left-0' : '-left-[280px]'}`}>
                        <div className='flex justify-between items-center mb-5'>
                            <div onClick={() => setShowSidebarLeftMobile(false)} className='w-[18px] h-[24px] text-white cursor-pointer'>
                                {closeIcon}
                            </div>
                            <Link className='block lg:hidden xl:block' to='/'>
                                <img loading='lazy' className='w-9 h-9 object-cover' src="/src/assets/images/logo.webp" alt="logo" />
