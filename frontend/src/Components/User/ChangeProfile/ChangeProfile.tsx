        ...
        <Dialog open={isShowChangeProfile} onClose={() => setIsShowChangeProfile(false)} maxWidth='xl'>
            <div className="flex flex-col max-w-4xl xl:w-screen">
                ...
                <div className="flex items-center flex-col w-full">
                    ...
                    {postImage ?
                        <div className="bg-black h-48 w-48 overflow-hidden rounded-full">
                            <img draggable="false" className="object-contain h-full w-full" src={postPreview as string} alt="post" />
                        </div>
                        :
                        <div onDragEnter={handleDragChange} onDragLeave={handleDragChange} className={`${dragged && 'opacity-40'} relative bg-white h-52 w-full flex flex-col gap-2 items-center justify-center mx-16`}>
                    ...
                    <div className="flex flex-col border-l w-full bg-white">
