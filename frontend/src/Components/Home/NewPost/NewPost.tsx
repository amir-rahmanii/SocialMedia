            ...
            <div className="flex flex-col xl:w-screen max-w-4xl border dark:border-gray-300/20 border-gray-300 ">
                ...
                <div className="flex bg-white dark:bg-black  md:flex-row md:items-start items-center flex-col w-full">
                    ...
                    {postImage.length > 0 ?
                        ...
                        :
                        <div onDragEnter={handleDragChange} onDragLeave={handleDragChange} className={`${dragged && 'opacity-40'} relative bg-white dark:bg-black  h-36 md:h-[80vh] w-full flex flex-col gap-2 items-center justify-center mx-16 text-black dark:text-white`}>
